...
public class StudentControllerV2 {
	 ...
	 * 단순히 기본 생성자를 호출하여 ServiceV1에서 stdList와 fileName을
	 * 직접 관리하도록 하였다.
	 * 만약 list변수와 파일을 다른 것으로 바꾸려면 어쩔수 없이 ServiceV1코드를
	 * 변경해야 한다.
	 * 
	 * 하지만 V2에서는 ControllerV2에서 ServiceV2를 사용할때
	 * stdList와 fileName을 생성자 매개변수로 전달하고 있다.
	 * 이러한 패턴은 Controller와 Service 간에 결합도를 낮추어
	 * 더 좋은 패턴의 코드가 된다.
	 */
